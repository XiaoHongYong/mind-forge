 ...
 *
 * Same shape as `mindforge-server` and `mindforge-saas`, deliberately:
...
export default defineConfig({
  test: {
    ...
    include: [
      ...
      // The layout and geometry live in @mindforge/mindmap-core; their
      // tests moved with them, and this project is what runs them.
      '../packages/*/src/**/__tests__/**/*.test.ts?(x)',
    ],
    alias: {
      '@mindforge/mindmap-core': new URL('../packages/mindmap-core/src/index.ts', import.meta.url).pathname,
    },
  },
});
