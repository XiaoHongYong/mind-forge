 ...
 *
 * Two closed layouts, `freemind` and `mac` — see docs/ui-rework-plan.md
...
export const SHORTCUTS: ShortcutDef[] = [
  ...
  { id: 'node.linkFile', label: 'Link to a file', group: 'Nodes', freemind: ['Mod+K'], mac: ['Mod+K'] },
  { id: 'node.attachFile', label: 'Attach file', group: 'Nodes', freemind: ['F6'], mac: ['Mod+Shift+O'] },
  ...
  { id: 'view.layoutMode', label: 'Toggle structure', group: 'View', freemind: ['Mod+Shift+M'], mac: ['Mod+Shift+M'] },
