...
import { treeToMmforge } from './mmforgeFormat';

export type ExportFormatId = 'mmforge' | 'md' | 'freemind' | 'freeplane' | 'wisemapping' | 'xmind';
...
export const EXPORT_FORMATS: ExportFormat[] = [
  {
    ...
    id: 'mmforge',
    label: 'MindForge (.mmforge)',
    extension: '.mmforge',
    serialize: (root) => new Blob([treeToMmforge(root)], { type: 'application/json' }),
  },
  {
    id: 'md',
    label: 'Markdown (.md)',
